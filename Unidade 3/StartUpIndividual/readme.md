...
Classifique os dados no seu mapa conceitual:
...
Indique tecnologias ou processos (ex: algoritmos, dashboards, IA).

Relacione com elementos do mapa:
...
Elementos de sistemas: entrada, processamento, saída, feedback

 
Resultado esperado
Ao final, você deverá ter realizado a atividade proposta e publicado seu trabalho no repositório da disciplina.

Descrição da startup (1–2 páginas)

Explicação do sistema de informação

Mapa conceitual visual:  [DADOS] → [PROCESSAMENTO] → [INFORMAÇÃO] → [CONHECIMENTO] → [DECISÃO] → [VALOR]
